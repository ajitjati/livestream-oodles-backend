...
document.write("<script type='text/javascript' src='https://" + server + "/jWebrtc/bower_components/detectrtc/DetectRTC.js'></script>"); 
...
document.write("<script type='text/javascript' src='https://" + server + "/jWebrtc/js/index.js?5'></script>");
document.write("<script type='text/javascript' src='https://" + server + "/jWebrtc/js/status.js?7'></script>"); 
